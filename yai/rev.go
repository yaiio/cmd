// The command line tool for running Yai apps.
package main
...
const header = `~
~ yai! http://yai.github.io
~
`

const usageTemplate = `usage: yai command [arguments]

The commands are:
{{range .}}
    {{.Name | printf "%-11s"}} {{.Short}}{{end}}

Use "yai help [command]" for more information.
`

var helpTemplate = `usage: yai {{.UsageLine}}
{{.Long}}
`
